...
class Settings
{
    ...
    public const OLD_LIB = \PhpOffice\PhpWord\Shared\ZipArchive::class; 
     ...
     * @const string
     */
    public const UNIT_TWIP = 'twip'; 
    public const UNIT_CM = 'cm';
    public const UNIT_MM = 'mm';
    public const UNIT_INCH = 'inch';
    public const UNIT_POINT = 'point'; 
    public const UNIT_PICA = 'pica'; 
    ...
    public const DEFAULT_FONT_CONTENT_TYPE = 'default'; 
