...
class TablePosition extends AbstractStyle
{
     ...
     */
    const VANCHOR_TEXT = 'text'; 
    const VANCHOR_MARGIN = 'margin'; 
    const VANCHOR_PAGE = 'page'; 
     ...
     */
    const HANCHOR_TEXT = 'text'; 
    const HANCHOR_MARGIN = 'margin'; 
    const HANCHOR_PAGE = 'page'; 
     ...
     */
    const XALIGN_LEFT = 'left'; 
    const XALIGN_CENTER = 'center'; 
    const XALIGN_RIGHT = 'right'; 
    const XALIGN_INSIDE = 'inside'; 
    const XALIGN_OUTSIDE = 'outside'; 
     ...
     */
    const YALIGN_INLINE = 'inline'; 
    const YALIGN_TOP = 'top'; 
    const YALIGN_CENTER = 'center'; 
    const YALIGN_BOTTOM = 'bottom'; 
    const YALIGN_INSIDE = 'inside'; 
    const YALIGN_OUTSIDE = 'outside'; 
